    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription className="font-extrabold uppercase text-destructive">
            This will also delete all videos in the collection.
          </DialogDescription>
          <DialogDescription>
            If you want to delete the collection only, first remove all videos from the collection.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
          <DialogClose asChild>
