...
export const Route = createFileRoute('/_dashboard/playlists')({
...
function LibrariesPage() {
	...
	return (
		<>
			<DashboardHeader
				heading="Video Playlists"
				text="Select a video library to view and manage the playlists for that library"
			>
							...
							>
								<Card className="hover:bg-secondary transition-colors h-full">
									<CardHeader>
										...
										<CardTitle>{library.name} Playlists</CardTitle>
									</CardHeader>
