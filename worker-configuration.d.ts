/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 9b492e76f019599173192f4883ea55e3)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_BUNNY_LIBRARY_ID: string;
		VITE_BUNNY_STREAM_CDN: string;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		TURSO_DB_URL: string;
		TURSO_DB_TOKEN: string;
		VITE_R2_BUCKET_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUNNY_API_KEY" | "BUNNY_STREAM_TOKEN" | "VITE_BUNNY_LIBRARY_ID" | "VITE_BUNNY_STREAM_CDN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "TURSO_DB_URL" | "TURSO_DB_TOKEN" | "VITE_R2_BUCKET_URL" | "TURNSTILE_SECRET_KEY" | "VITE_TURNSTILE_SITE_KEY" | "RESEND_API_KEY">> {}
}
