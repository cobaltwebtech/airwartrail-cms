/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e8f845c85aabd5bcc2273c93676bea96)
// Runtime types generated with workerd@1.20250712.0 2025-04-29 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		TURNSTILE_PUBLIC_KEY: "3x00000000000000000000FF";
		BUNNY_API_KEY: string;
		BUNNY_STREAM_TOKEN: string;
		PUBLIC_BUNNY_LIBRARY_ID: string;
		PUBLIC_BUNNY_STREAM_CDN: string;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		TURSO_DB_URL: string;
		TURSO_DB_TOKEN: string;
		R2_BUCKET_NAME: string;
		PUBLIC_R2_BUCKET_URL: string;
		AIRWARTRAIL_ASSETS: R2Bucket;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_PUBLIC_KEY" | "BUNNY_API_KEY" | "BUNNY_STREAM_TOKEN" | "PUBLIC_BUNNY_LIBRARY_ID" | "PUBLIC_BUNNY_STREAM_CDN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "TURSO_DB_URL" | "TURSO_DB_TOKEN" | "R2_BUCKET_NAME" | "PUBLIC_R2_BUCKET_URL">> {}
}
